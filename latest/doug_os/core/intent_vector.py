...
# Extended list of servo names.  As the system grows new servos (e.g. news
# intelligence and macro economic) we must update this literal to
# maintain type safety.  Keep names in sync with modules in
# ``doug_os.servos``.
ServoName = Literal[
    "market",
    "onchain",
